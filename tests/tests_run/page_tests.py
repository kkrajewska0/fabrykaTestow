...
from tests.page_objects import main_page, checkboxes_page, key_presses_page, hovers_page, users_page, input_page, dropdown_page, add_remove_page, basic_auth_page, form_page, drag_and_drop_page, date_picker_page, iFrame_page, status_codes_page
