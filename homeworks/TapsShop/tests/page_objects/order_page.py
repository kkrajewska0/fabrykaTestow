from homeworks.TapsShop.tests.helpers.support_functions import *
from selenium.webdriver.support.select import Select
from homeworks.TapsShop.tests.helpers.DataGenerator import *
...
order_receive = '//*[@id="post-8"]/header/h1'
...
def order_received_visible(driver_instance):
    wait_for_visibility_of_element_by_xpath(driver_instance, order_receive, time_to_wait=30)
    elem = driver_instance.find_element_by_xpath(order_receive)
    elem.get_attribute("Zamówienie otrzymane")
