...
from homeworks.TapsShop.config.test_settings import TestSettings
from homeworks.TapsShop.tests.page_objects import main_page, cart_page, order_page
...
class Tests(unittest.TestCase):
    ...
    def test1_process(self):
        ...
        self.assertTrue(order_page.order_received_visible(self.driver))
